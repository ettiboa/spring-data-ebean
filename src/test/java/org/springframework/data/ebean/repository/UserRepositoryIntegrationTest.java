...
import org.springframework.data.ebean.sample.domain.query.QAddress;
import org.springframework.test.context.junit.jupiter.SpringJUnitConfig;

/**
 * @author Xuegui Yuan
 */
@SpringJUnitConfig(classes = {SampleConfig.class, QAddress.class, FullName.class})
class UserRepositoryIntegrationTest {
    ...
    void updateQuery() throws Exception {
        assertThat(userRepository.updateQuery())
            .isNotNull();
    }

    @Test
    void sqlUpdateOf() throws Exception {
        assertThat(userRepository.sqlUpdateOf("update user set age = 30 where id = ?"))
            .isNotNull();
    }
    ...
    void update() throws Exception {
        ...
        assertThat(u).isNotNull();
        assertThat(u.getAge()).isEqualTo(31);
    }
    ...
    void updateAll() throws Exception {
        ...
        for (User u : users) {
            assertThat(u).isNotNull();
            assertThat(u.getAge()).isEqualTo(32);
        }
    }
/*
    @Test
