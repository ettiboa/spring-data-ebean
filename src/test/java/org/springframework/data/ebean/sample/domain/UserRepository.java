...
public interface UserRepository extends EbeanRepository<User, Long> {
    ...
    @Modifying
    int changeUserEmailAddress(@Param("oldEmail") String oldEmail,
    ...
    List<User> findAllByEmailAddressAndFullNameLastName(@Param("emailAddress") String emailAddress,
        @Param("lastName") String lastName);

    @Query(value = "where emailAddress = :emailAddress")
    Page<User> findUserByEmailAddressEqualsOql(@Param("emailAddress") String lastName,
        Pageable page);
